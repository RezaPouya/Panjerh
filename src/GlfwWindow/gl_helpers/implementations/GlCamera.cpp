...
GlCamera::GlCamera(int width, int height, glm::vec3 position)
{
...
void GlCamera::Matrix(float FOVdeg, float nearPlane, float farPlane, GlShader& shader, const char* uniform)
{
